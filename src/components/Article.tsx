const Article = () => {
    return (
        <div>
            ...
            <hr />
            <h2 id="1">What to expect from here on out</h2>
            <p>
            ...
            <figure>
                <img
                src="https://img.freepik.com/free-vector/cute-man-teacher-online-education-cartoon-vector-icon-illustration-people-education-icon-isolated_138676-8413.jpg"
