...
const TermAndConditions = () => {
    const breadcumb = [
        { id: 1, name: 'Home', link: '/' },
        { id: 2, name: 'Terms and Conditions', link: '/terms-and-conditions' },
    ];
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                "Us" or "Our" in this Agreement) refers to Preline.
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                        ...
                                        <li>
                                            <p>
                                                <strong>Website</strong> refers to Preline, accessible from{" "}
                                                <a
