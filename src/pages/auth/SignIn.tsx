                ...
                <div className="p-4 sm:p-7">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            ...
                            <a className="text-blue-600 decoration-2 hover:underline font-medium" href="/sign-up">
                                Sign up here
                            </a>
                        </p>
                    </div>
                            ...
                            <div className="grid gap-y-4">
                                ...
                                <div>
                                    <div className="flex justify-between items-center">
                                        ...
                                        <a href="/forgot-password" className="text-sm text-blue-600 decoration-2 hover:underline font-medium">
                                            Forgot password?
                                        </a>
                                    </div>
                                    <div className="relative">
                                        <input type="password" id="password" name="password"
                                        className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" aria-describedby="password-error"/>
                                        <div className="hidden absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                                        <FiAlertCircle className="h-5 w-5 text-red-500" />
                                        </div>
                                    </div>
